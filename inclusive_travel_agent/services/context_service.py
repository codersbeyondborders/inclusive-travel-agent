...
from inclusive_travel_agent.models.user_profile import UserProfile
from inclusive_travel_agent.services.user_profile_service import user_profile_service
